...
def save_activations(clip_name, target_name, target_layers, d_probe, 
    ...
    print("Saving CLIP text, image features and target activations")
...
def get_similarity_from_activations(target_save_name, clip_save_name, text_save_name, similarity_fn, 
                                   return_target_feats=True, device="mps"):
...
def get_cos_similarity(preds, gt, clip_model, mpnet_model, device="mps", batch_size=200):
    """
