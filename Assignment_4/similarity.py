...
def cos_similarity_cubed(clip_feats, target_feats, device='mps', batch_size=10000, min_norm=1e-3):
    """
...
def cos_similarity(clip_feats, target_feats, device='mps'):
    with torch.no_grad():
...
def soft_wpmi(clip_feats, target_feats, top_k=50, a=10, lam=1, device='mps',
...
def wpmi(clip_feats, target_feats, top_k=28, a=2, lam=0.6, device='mps', min_prob=1e-7):
...
def rank_reorder(clip_feats, target_feats, device="mps", p=3, top_fraction=0.05, scale_p=0.5):
    """
